...
input_path="/$data_dir_path/ne/various_context/separate/wikilinks_ne.jsonl"
...
input_path="/$data_dir_path/ne/various_context_mention/separate/wikilinks_ne.jsonl"
...
## Non_NE
input_path="/$data_dir_path/non_ne/separate/sampled_non_ne.jsonl"
